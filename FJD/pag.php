...
$resultevento = mysqli_query($mysqli, "SELECT * FROM eventos where nombre='$cate'");
...
<?php 
 ...
 <table class="tt">
  <?php 
  $t = $cate;
    $result1 = mysqli_query($mysqli, "SELECT * FROM Blog where categoria ='$t' order by rand()");

    while($res = mysqli_fetch_array($result1)) {
    echo "<center><td><a href=/proyectofinal/pag.php?id=".$res['id']."><img src=/proyectofinal/imgs/".$res["imagen"].".png width=60px height=60px position=fixed ><p>".$res['titulo']."</td><td>".$res["subtitulo"]."</td></center>";
    echo "<td><img src=/proyectofinal/imgs/".$res["categoria"].".png width=40px height=40px > </td>";
